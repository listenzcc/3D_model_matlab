...
X = arrow(pos=vector(-10,-10,-10), axis=vector(5,0,0), color=color.red, shaftwidth=0.5)
Y = arrow(pos=vector(-10,-10,-10), axis=vector(0,5,0), color=color.green, shaftwidth=0.5)
Z = arrow(pos=vector(-10,-10,-10), axis=vector(0,0,5), color=color.blue, shaftwidth=0.5)
